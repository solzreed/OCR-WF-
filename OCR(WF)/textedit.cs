...
namespace OCR_WF_
{
    class textedit
    {
        ...
        {
            string raw = str.Replace(" ", String.Empty).Replace("０", "0").Replace("１", "1").Replace("２", "2").Replace("３", "3").Replace("４", "4").Replace("５", "5").Replace("６", "6").Replace("７", "7").Replace("８", "8").Replace("９", "9").Replace("",string.Empty).Replace("로격파",string.Empty).Trim();
           ...
           /*where !a.Contains("격파") */ select a.Trim()).ToList();
